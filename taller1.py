...
Original file is located at
    https://colab.research.google.com/drive/1OTQkaunuOingS6bmynpwUgUppkoSWp4K
...
multiplicacion = a*b
print("La multiplicacion entre a y b es:",multiplicacion)

division = a/b
print("La division entre a y b es:",division)

modulo = a%b
print("El resto entre a y b es:",modulo)

Potencia = a**b
print("La potencia de a elevado b es:",Potencia)

Division_entera = a//b
print("La divisoin entera entre a y b es:",Division_entera)

"""**EJERCICIO 5: Operadores con cadenas**"""

Saludo = "Hola mundo"

print("El primer caracter de la frase Hola mundo es:", Saludo[0])
print("Los ultimos 5 caracters de la frase Hola mundo son:", Saludo[5:])

Saludo_2 = " ¿Como estas?"
saludo_completo = Saludo + Saludo_2
print(saludo_completo)

saludo_mayusculas = saludo_completo.upper()
print(saludo_mayusculas)

saludo_completo = saludo_completo.replace('mundo', 'Python')
print(saludo_completo)